...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'scheduled', 'published', 'archived');
  CREATE TYPE "public"."enum_authors_social_links_platform" AS ENUM('twitter', 'linkedin', 'facebook', 'website');
  CREATE TYPE "public"."enum_site_settings_social_links_platform" AS ENUM('twitter', 'linkedin', 'facebook');
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'SEO Builder' NOT NULL,
  	"site_url" varchar DEFAULT 'http://localhost:3000' NOT NULL,
  	"blog_path" varchar DEFAULT '/blog',
  ...
  ALTER TABLE "site_settings" ADD CONSTRAINT "site_settings_default_author_id_authors_id_fk" FOREIGN KEY ("default_author_id") REFERENCES "public"."authors"("id") ON DELETE set null ON UPDATE no action;
